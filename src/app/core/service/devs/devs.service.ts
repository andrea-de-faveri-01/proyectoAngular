...
export class DevsService {
  constructor(private apiDevsService: ApiDevsService) {}
  ...
  public createDev(body: DevRequestBody): Observable<DevI> {
    return this.apiDevsService
      .createApiDev(body)
      .pipe(map((apiDev) => this.transformDev(apiDev)));
  }
